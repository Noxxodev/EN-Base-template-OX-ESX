...
Config.localisation = {
    {
        ...
        titre = 'Car rental', -- Nom de l'interaction alt
...
Config.vehicule = {
    {
        ...
        description = "You can rent a Sultan for : 200$", -- Descritption du menu
    ...
    },
    {
        label = "Faggio",
        vehicule = "faggio",
        description = "You can rent a Faggio for : 10$",
        prix = 10,
